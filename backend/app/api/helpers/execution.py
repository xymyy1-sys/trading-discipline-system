...
def _execution_state_out(
    ...
    return PositionExecutionStateOut(
        ...
        profit_snapshot=ProfitProtectionSnapshotOut(
            ...
            current_profit_pct=_safe_float(getattr(snapshot, "current_profit_pct", 0)),
            maximum_profit_pct=_safe_float(getattr(snapshot, "maximum_profit_pct", 0)),
            profit_drawdown_pct=_safe_float(getattr(snapshot, "profit_drawdown_pct", 0)),
            maximum_price=_safe_float(getattr(snapshot, "maximum_price", 0)),
            maximum_profit_at=getattr(snapshot, "maximum_profit_at", None),
            day_max_profit_pct=_safe_float(getattr(snapshot, "day_max_profit_pct", 0)),
            day_max_profit_at=getattr(snapshot, "day_max_profit_at", None),
            protection_level=snapshot.protection_level,
            protection_floor=_safe_float(getattr(snapshot, "protection_floor", 0)),
