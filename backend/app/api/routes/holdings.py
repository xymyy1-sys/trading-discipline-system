...
def get_intraday_collector_status() -> IntradayCollectorStatusOut:
    ...
    return IntradayCollectorStatusOut(
        ...
        market_regime_running=bool(status.get("market_regime_running")),
        market_regime_interval_seconds=int(status.get("market_regime_interval_seconds") or 0),
        market_regime_last_success_at=status.get("market_regime_last_success_at"),
        market_regime_last_error=str(status.get("market_regime_last_error") or ""),
        ...
        simulation_match_running=bool(status.get("simulation_match_running")),
        simulation_match_last_success_at=status.get("simulation_match_last_success_at"),
        simulation_match_last_error=str(status.get("simulation_match_last_error") or ""),
        ...
        close_expectation_completed_date=status.get("close_expectation_completed_date"),
        close_shadow_equity_completed_date=status.get("close_shadow_equity_completed_date"),
