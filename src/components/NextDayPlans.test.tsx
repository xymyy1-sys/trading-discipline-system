...
const plan: NextDayPlanOut = {
  ...
  auction_plan: {
    ...
    mainline_name: '', mainline_rank: null, mainline_score: null, mainline_level: '待验证', is_mainline: null,
    theme_stage: '数据不足', theme_stage_reason: '缺少题材资金与阶段证据', identity_roles: [],
    identity_action: '只观察', position_rule: '数据不足时禁止新开打板仓', theme_evidence: [],
  },
  forbidden_actions: [],
  risk_priority: 2,
  risk_warnings: [],
