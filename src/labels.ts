const LABELS: Record<string, string> = {
  ...
  SECTOR_FLOW_TURN_OUT: '板块资金由流入拐为流出',
  SECTOR_FLOW_TURN_IN: '板块资金由流出拐为流入',
  SECTOR_FLOW_WEAKENING: '板块资金边际转弱',
  SECTOR_FLOW_RECOVERY: '板块资金边际修复',
  SHRINKING_RISE_DIVERGENCE: '缩量上涨与资金背离',
  SHRINKING_REBOUND_UNCONFIRMED: '缩量反弹未确认',
  SHRINKING_DECLINE_EXHAUSTION_WATCH: '缩量下跌抛压衰减观察',
  SHRINKING_DECLINE_WEAKNESS: '缩量下跌但资金仍弱',
  SHRINKING_PULLBACK_SUPPORT_WATCH: '缩量回踩支撑观察',
  VOLUME_DOWN_FLOW_ACCELERATION: '放量下跌且资金加速流出',
  FLOW_TURN_OUT_DISTRIBUTION_WARNING: '上涨中资金拐出警告',
  FLOW_TURN_IN_REBOUND_WATCH: '下跌中资金拐入观察',
  VOLUME_FLOW_STRENGTH_CONFIRMED: '放量上涨与资金同步增强',
